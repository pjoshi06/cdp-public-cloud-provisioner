...
==== C): 
Start editing the **configfile** with the help of editor of your choice. Don't add any 'new line' after the last entry in the file. Refer to below table for defining
