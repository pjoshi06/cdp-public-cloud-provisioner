...
e.g : If in the configfile the value of WORKSHOP_NAME is **ibmwrkshop** the out put file will be **ibmwrkshop.txt**

This file contains details about the provisioned Keycloak Server and the SSO URL which will be used for participants for login.
